 ...
 function renderBatchCard(item) {
  ...
  return `
    <div class="batch-card" id="batch-${escapeHtml(item.id)}">
      ...
      <div
        class="batch-summary"
        onclick="toggleBatchDetails('${escapeHtml(item.id)}')"
      >
      ...
      <div class="batch-details">
        ...
        <div class="action-row">
          ...
          <button
            type="button"
            class="ghost-btn"
            onclick="editProduct('${escapeHtml(item.id)}')"
          >
            Szerkesztés
          </button>
          ...
          <button
            type="button"
            class="ghost-btn"
            onclick="startConsumeProduct('${escapeHtml(item.id)}')"
          >
            Elfogyasztva
          </button>
          ...
          <button
            type="button"
            class="ghost-btn"
            onclick="startWasteProduct('${escapeHtml(item.id)}')"
          >
            Kidobva
          </button>
          ...
          <button
            type="button"
            class="ghost-btn"
            onclick="addBatchToShopping('${escapeHtml(item.id)}')"
          >
            Bevásárlólista
          </button>
